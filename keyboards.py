    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                InlineKeyboardButton(
                    text="✅ Московский 34", callback_data="moscow_34"
                ),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="✅ Тельмана 68а", callback_data="telmana_68A"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="✅ Бежицкая 356а", callback_data="bezitskaya_356a"
                ),
                InlineKeyboardButton(
                    text="✅ Крахмалёва 23", callback_data="krakhmaleva_23"
                ),
            ],
            [
            ...
            [
                InlineKeyboardButton(
                    text="✅ Интернационала 15", callback_data="international_15"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Интернационала 25", callback_data="international_25"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Сосновый бор 1А", callback_data="sosnovy_bor_1A"
                ),
            ],
            [
                InlineKeyboardButton(
...
def shops_keyboard_end():
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Литейная 68", callback_data="foundry_68_end"
                ),
                InlineKeyboardButton(
                    text="✅ Никитина 5", callback_data="nikitin_5_end"
                ),
            ],
            [
                InlineKeyboardButton(
                ...
                InlineKeyboardButton(
                    text="✅ Московский 34", callback_data="moscow_34_end"
                ),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="✅ Тельмана 68а", callback_data="telmana_68A_end_end"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="✅ Бежицкая 356а", callback_data="bezitskaya_356a_end"
                ),
                InlineKeyboardButton(
                    text="✅ Крахмалёва 23", callback_data="krakhmaleva_23_end"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Пушкина 73", callback_data="pushkin_73_end"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text="✅ Интернационала 15", callback_data="international_15_end"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Интернационала 25", callback_data="international_25_end"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Сосновый бор 1А", callback_data="sosnovy_bor_1A_end"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Станке Димитрова 67",
                    callback_data="stanke_dimitrova_67_end",
                ),
            ],
            [
                InlineKeyboardButton(
                    text="✅ Станке Димитрова 108Б",
                    callback_data="stanke_dimitrova_108b_end",
                ),
            ],
            [InlineKeyboardButton(text="⬅ Назад", callback_data="back")],
        ]
